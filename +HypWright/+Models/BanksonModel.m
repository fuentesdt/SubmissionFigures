classdef BanksonModel < HypWright.Models.Base
    ...
    methods (Static)
        function [Y,T,sol] = evaluate(params,tSpan,Y0)
            ...
            params = HypWright.Models.BanksonModel.parseParams(params);
...
%             end
        ...
        function [x,resultParams,resnorm,residual] = fitData(params,guess,...
            ...
            params = HypWright.Models.BanksonModel.parseParams(params);
            Y0 = ydata(:,1);
            fun = @(x,xdata)HypWright.Models.BanksonModel.fitFunction(...
        ...
        function dataCompare(params,xdata,ydata,varargin)
            ...
            p.parse(varargin{:})
            Y0 = ydata(:,1);
            Y = HypWright.Models.BanksonModel.evaluate(params,xdata,Y0);
    ...
    methods (Static, Access = protected)
        function paramsOut = parseParams(paramsIn)
            ...
            default = struct('Kab',0,'Kba',0,'T1a',56,'T1b',31,'flipAngle',0,...
                'TR',1,'b',@(t)0.*[t;t],'kve',0.02,'ve',0.91,'t0',0,...
        ...
        function Y = fitFunction(params,x,xNames,tSpan,Y0)
            ...
            Y = x(end)*HypWright.Models.BanksonModel.evaluate(params,tSpan,Y0);
        end
    end
end